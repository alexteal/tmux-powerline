...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"mailcount 9 255" \
		#"now_playing 234 37" \
		"cpu 235 208 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		#"load 237 167" \
		#"tmux_mem_cpu_load 234 136" \
		"battery 235 220 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		#"weather 37 255" \
		#"rainbarf 0 ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR}" \
		#"xkb_layout 125 7 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"date_day 235 82 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"date 235 69 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"time 235 141 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
